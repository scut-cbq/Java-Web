...
<div id="content" class="wrap clear">
    <div class="description clear">
        <div class="dleftArea fl">
            <div class="topItem">
                <a href="">
                    <img src="../../image/3.png" alt="a bite of china.png" height="300" width="500">
                </a>
            </div>
        </div>
            ...
            <div class="itemInfo fl clear">
                ...
                <div id="summary">
                    <div id="summary-price">
                        ...
                        <div class="dd">
                            <strong class="p-price" id="jd-price">￥150.00</strong>
                        </div>
                    </div>
                ...
                <dl class="amount dl clear">
                    ...
                    <dd>
                        ...
                        <em>(库存<span id="J_SpanStock" class="count">328</span>件)</em>
                    </dd>
                    <div id="summary-service" clstag="shangpin|keycount|product|1|fuwu">
                        <div class="dt">简 介：</div>
                        <div class="dd">
                            <span class="deliver">记录舌尖上的中国</span>
                        </div>
                    </div>
                </dl>
                <!-- /购买数量 -->
