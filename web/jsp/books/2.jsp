...
<div id="content" class="wrap clear">
    <div class="description clear">
        <div class="dleftArea fl">
            <div class="topItem">
                <a href="">
                    <img src="../../image/2.png" alt="new concept.png" height="300" width="500">
                </a>
            </div>
        </div>
            ...
            <div class="itemInfo fl clear">
                ...
                <div id="summary">
                    <div id="summary-price">
                        ...
                        <div class="dd">
                            <strong class="p-price" id="jd-price">￥78.00</strong>
                        </div>
                    </div>
