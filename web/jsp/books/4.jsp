...
<div id="content" class="wrap clear">
    <div class="description clear">
        <div class="dleftArea fl">
            <div class="topItem">
                <a href="">
                    <img src="../../image/4.png" alt="hello art.png" height="300" width="500">
                </a>
            </div>
        </div>
            ...
            <div class="itemInfo fl clear">
                ...
                <div id="summary">
                    <div id="summary-price">
                        ...
                        <div class="dd">
                            <strong class="p-price" id="jd-price">￥55.0</strong>
                        </div>
                    </div>
                ...
                <dl class="amount dl clear">
                    ...
                    <dd>
                        ...
                        <em>(库存<span id="J_SpanStock" class="count">12</span>件)</em>
                    </dd>
                    <div id="summary-service" clstag="shangpin|keycount|product|1|fuwu">
                        <div class="dt">简 介：</div>
                        <div class="dd">
                            <span class="deliver">带你走进艺术的殿堂</span>
                        </div>
                    </div>
                </dl>
                <!-- /购买数量 -->
